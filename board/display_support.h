...
#define DEMO_PANEL_PH720128T003 2  // MaaXBoard 7 inch display (PowerTip PH720128T003-ZBC02)
#define DEMO_PANEL_AES_ACC_MAAX_DISP2 3
...
#define DEMO_PANEL DEMO_PANEL_AES_ACC_MAAX_DISP2
#else
#define DEMO_PANEL DEMO_PANEL_PH720128T003  // MaaXBoard display selected
#endif
#endif
...
#elif ((DEMO_PANEL == DEMO_PANEL_PH720128T003) || (DEMO_PANEL == DEMO_PANEL_AES_ACC_MAAX_DISP2))  // MaaXBoard panel
#define DEMO_PANEL_WIDTH  (720)
#define DEMO_PANEL_HEIGHT (1280)
